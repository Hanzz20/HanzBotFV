...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = 'Welcome @user to @subject!👋\nJangan Lupa Intro!\nGa Intro Ga Cakep Cuy :v'
  conn.bye = 'Bye @user!👋\nKapan-Kapan Balik Lagi Yaa :D'
  conn.spromote = 'Selamat! Sekarang @user adalah admin di @subject!'
  conn.sdemote = '@user sekarang bukan admin di grup @subject!'
